...
import sys, os, base64, re, time, hashlib, shutil, inspect
...
config.plugins.navibar.placesize = ConfigSelection(default="450", choices = [("0",_("0")),("50",_("50")),("100",_("100")),("150",_("150")),("200",_("200")),("250",_("250")),("300",_("300")),("350",_("350")),("400",_("400")),("450",_("450")),("500",_("500")),("525",_("525")),("550",_("550")),("900",_("900"))])
...
class navibar_config1(Screen, ConfigListScreen, HelpableScreen):
	skin = """
		<screen position="center,center" size="1080,720" title="NaviBar Setup">
			<widget name="config" position="5,5" size="1070,210" itemHeight="35" scrollbarMode="showOnDemand" />
			<eLabel position="5,220" size="1080,3" zPosition="10" backgroundColor="#aaaaaa"/>
			<widget name="config2" position="5,230" size="610,420" scrollbarMode="showOnDemand" />
			<widget name="config3" position="620,230" size="450,420" scrollbarMode="showOnDemand" />
			<widget name="balken" position="620,650" size="690,35" valign="top" backgroundColor="#404040" font="Regular;20"/>
			<widget name="descrip2" position="5,650" valign="top" zPosition="2" size="610,35" backgroundColor="#404040" font="Regular;20" />
			<widget name="label_green" position="35,688" size="200,39" zPosition="2" backgroundColor="#404040" font="Regular;20" transparent="1"/>
			<widget name="label_red" position="295,688" size="200,39" zPosition="2" backgroundColor="#404040" font="Regular;20" transparent="1"/>
			<widget name="label_blue" position="35,688" size="200,39" zPosition="2" backgroundColor="#404040" font="Regular;20" transparent="1"/>
			<widget name="pic_red" pixmap="~/images/button_red.png" zPosition="3" position="5,690" size="35,35" alphatest="blend" />
			<widget name="pic_green" pixmap="~/images/button_green.png" zPosition="3" position="265,690" size="35,35" alphatest="blend" />
			<widget name="pic_blue" pixmap="~/images/button_blue.png" zPosition="3" position="5,690" size="35,35" alphatest="blend" />
			<widget name="ok" position="700,690" size="35,35" pixmap="~/images/button_ok.png" zPosition="2" alphatest="blend" />
			<widget name="info" position="750,690" size="35,35" pixmap="~/images/button_info.png" zPosition="2" alphatest="blend" />
			<widget name="pvr" position="800,690" size="35,35" pixmap="~/images/button_pvr.png" zPosition="2" alphatest="blend" />
			<widget name="menu" position="850,690" size="35,35" pixmap="~/images/button_menu.png" zPosition="2" alphatest="blend" />
			<ePixmap position="900,690" size="35,35" pixmap="~/images/button_bouquet.png" alphatest="blend" />
			<ePixmap position="950,690" size="35,35" pixmap="~/images/button_help.png" alphatest="blend" />
		</screen>"""
	...
	def readconfig(self):
		...
		self["config2"].l.setItemHeight(35)

	def show_menu(self, name, hits, hide, sort, pw, section, descrip):
		res = [(name, hits, hide, sort, pw, section, descrip)]
		if int(hide) == 0:
			res.append(MultiContentEntryPixmapAlphaTest(pos=(10, 5), size=(20, 20), png=loadPNG(self.plugin_path+"/images/green.png")))
		else:
			res.append(MultiContentEntryPixmapAlphaTest(pos=(10, 5), size=(20, 20), png=loadPNG(self.plugin_path+"/images/red.png")))
		if int(pw) == 1:
			res.append(MultiContentEntryPixmapAlphaTest(pos=(40, 5), size=(20, 20), png=loadPNG(self.plugin_path+"/images/lock.png")))
		res.append(MultiContentEntryText(pos=(100, 0), size=(390, 35), font=8, text=name, flags=RT_HALIGN_LEFT))
		res.append(MultiContentEntryText(pos=(490, 0), size=(120, 35), font=8, text=section, flags=RT_HALIGN_LEFT))
		if self.selected and name == self.last_plugin_name:
			res.append(MultiContentEntryPixmapAlphaTest(pos=(70, 5), size=(20, 20), png=loadPNG(self.plugin_path+"/images/move.png")))
		return res
	...
	def readsections(self):
		...
		self["config3"].l.setItemHeight(35)

	def show_menu_section(self, section_name):
		res = [(section_name)]
		res.append(MultiContentEntryText(pos=(0, 0), size=(180, 35), font=7, text=section_name, flags=RT_HALIGN_LEFT))
		return res
...
class navi_wall(Screen):
	...
	def _onFirstExecBegin(self):
		...
		#for x in range(1,len(self.mainlist[0])+1):
			...
			postername = postername.replace(' ','_').replace('/',"_").replace('?',"_").replace('!',"_")
			#poster_path = "%s/icons/%s.png" % (self.plugin_path, postername.replace(' ','_'))
			#print config.plugins.navibar.dlpath.value
			poster_path = "%s/%s.png" % (config.plugins.navibar.dlpath.value, postername)
...
class navi_bar(Screen):
	def __init__(self, session, plugin_path, pluginlist, section, sectionlist):
		...
		self.section = section
		self.sectionlist = sectionlist
		#print("Navibar:", self.section, self.sectionlist)
		...
		self.skin = "<screen position=\"center," + self.placesize +"\" size=\"1280,200\" flags=\"wfNoBorder\" backgroundColor=\"transparent\" title=\"\"><eLabel position=\"0,55\" zPosition=\"0\" size=\"1280,120\" backgroundColor=\"" + self.color + "\" /><widget name=\"frame\" position=\"0,0\" size=\"110,115\" pixmap=\"~/images/sel.png\" zPosition=\"5\" alphatest=\"blend\" /><widget name=\"info\" position=\"0,110\" size=\"1280,40\" valign=\"top\" halign=\"center\" zPosition=\"10\" font=\"Regular;" + self.fontsize + "\" transparent=\"1\" backgroundColor=\"#000000\" /><widget name=\"disc\" position=\"0,378\" size=\"610,20\" valign=\"center\" halign=\"center\" zPosition=\"10\" font=\"Regular;19\" transparent=\"1\" />" + skincontent + "</screen>"
		Screen.__init__(self, session)
