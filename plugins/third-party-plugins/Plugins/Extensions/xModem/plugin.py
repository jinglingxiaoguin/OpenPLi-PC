...
config.plugins.xModem.imod.number.setUseableChars("0123456789PTW,@")
config.plugins.xModem.imod.port = ConfigText("/dev/tts/2", fixed_size=False)
config.plugins.xModem.imod.port.setUseableChars("0123456789abcdemstuvyABCMSTU/")
...
config.plugins.xModem.gprs.port.setUseableChars("0123456789abcdemstuvyABCMSTU/")
...
config.plugins.xModem.gprs.vendid.setUseableChars("0123456789abcdef")
config.plugins.xModem.gprs.prodid = ConfigText("", fixed_size=False)
config.plugins.xModem.gprs.prodid.setUseableChars("0123456789abcdef")
...
config.plugins.xModem.gprs.pincode.setUseableChars("0123456789")
...
config.plugins.xModem.cdma.port.setUseableChars("0123456789abcdemstuvyABCMSTU/")
...
config.plugins.xModem.cdma.vendid.setUseableChars("0123456789abcdef")
config.plugins.xModem.cdma.prodid = ConfigText("", fixed_size=False)
config.plugins.xModem.cdma.prodid.setUseableChars("0123456789abcdef")
...
config.plugins.xModem.peer.vendid.setUseableChars("0123456789abcdef")
config.plugins.xModem.peer.prodid = ConfigText("", fixed_size=False)
config.plugins.xModem.peer.prodid.setUseableChars("0123456789abcdef")
